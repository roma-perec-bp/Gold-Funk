...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			["Ender69",				"ender69",			"Programmer.",						                        "t.me/ender69bunker",	            "2fff00"],
			["SMixell",				"smixell",			"Additional Grafix.",						                "x.com/SMixels2",	             	"2fff00"],
			[""],
			...
			[""],
			["Psych Engine",		"psych",	"Literall engine where it all started (also more credits there)",   "https://github.com/ShadowMario/FNF-PsychEngine",			"ef05ff"],
			[""],
			["Funkin' Crew"],
			["ninjamuffin99",		"ninjamuffin99",	"Programmer of Friday Night Funkin'",						"https://x.com/ninja_muffin99",		"CF2D2D"],
			["EliteMasterEric",		"mastereric",		"Second programmer of Friday Night Funkin'",				"https://x.com/EliteMasterEric",	"FFBD40"],
