...
class ChartingState extends MusicBeatState implements PsychUIEventHandler.PsychUIEvent
{
	...
	[
		...
		['Camera Angle', 'Value 1:\nZoom Ease (it can be a FlxEase)\nValue 2: \nAngle (default 0)\nValue 3: Duration in steps (default 4.0)\nValue4: Which Camera Angle (camGame, camHUD, camNotes or camOther)'],
		['Play Animation', "Plays an animation on a Character,\nonce the animation is completed,\nthe animation changes to Idle\n\nValue 1: Animation to play.\nValue 2: Character (Dad, BF, GF)\nValue 3: Can animation be uninterruptable? (true or false)"],
